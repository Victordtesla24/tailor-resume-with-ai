            ...
            for para_idx, para in enumerate(self.doc.paragraphs):
                ...
                if style := self.style_map.get_paragraph_style(para_idx):
                    ...
                    if style["space_before"]:
                        new_para.paragraph_format.space_before = (
                            style["space_before"]
                        )
                    if style["space_after"]:
                        new_para.paragraph_format.space_after = (
                            style["space_after"]
                        )
                    if style["line_spacing"]:
                        new_para.paragraph_format.line_spacing = (
                            style["line_spacing"]
                        )
                ...
                if run_styles:
                    ...
                    segments = self._split_by_style_segments(
                        text,
                        run_styles
                    )
